...
def drawCaption(convas, captions, ixtoword, vis_size, off1=2, off2=2):
    ...
    fnt = ImageFont.truetype('/userhome/34/ylpeng2/AttnGAN/code/miscc/cmr10.ttf', 40)
    ...
    for i in range(num):
        ...
        for j in range(num_attn):
            ...
            if (vis_size // att_sze) > 1:
                one_map = \
                    skimage.transform.resize(one_map, output_shape = (img.shape[0], img.shape[1], img.shape[2]))
